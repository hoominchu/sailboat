(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{
    let g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.nlp = f()}})(function(){
    let define,
        module, exports;return (function e(t, n, r){function s(o, u){if(!n[o]){if(!t[o]){
    const a = typeof require == "function" && require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);
    const f = new Error("Cannot find module '" + o + "'");throw f.code="MODULE_NOT_FOUND",f}
    const l = n[o] = {exports: {}};t[o][0].call(l.exports,function(e){
    const n = t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0; o<r.length; o++)s(r[o]);return s})({1:[function(_dereq_, module, exports){
    (function (global){
        /* efrt trie-compression v2.0.3  github.com/nlp-compromise/efrt  - MIT */
        !function(r){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=r();else if("function"==typeof define&&define.amd)define([],r);else{
            let e;e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,e.unpack=r()}}(function(){return function r(e, n, o){function t(u, f){if(!n[u]){if(!e[u]){
            const s = "function" == typeof _dereq_ && _dereq_;if(!f&&s)return s(u,!0);if(i)return i(u,!0);
            const a = new Error("Cannot find module '" + u + "'");throw a.code="MODULE_NOT_FOUND",a}
            const c = n[u] = {exports: {}};e[u][0].call(c.exports,function(r){
            const n = e[u][1][r];return t(n?n:r)},c,c.exports,r,e,n,o)}return n[u].exports}for(var i="function"==typeof _dereq_&&_dereq_,u=0; u<o.length; u++)t(o[u]);return t}({1:[function(r, e, n){"use strict";
                const o = 36,
                    t = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ", i = t.split("").reduce(function (r, e, n) {
                        return r[e] = n, r
                    }, {}), u = function (r) {
                        ...
                        for (; e--;) {
                            const u = r % o;
                            i = String.fromCharCode((u < 10 ? 48 : 55) + u) + i, r = (r - u) / o
                        }
                        return i
                    }, f = function (r) {
                        ...
                        const e = 0,
                            n = 1, t = o, u = 1;
                        for (; n < r.length; e += t, n++, t *= o) ;
                        for (const f = r.length - 1; f >= 0; f--, u *= o) {
                            let s = r.charCodeAt(f) - 48;
                            s > 10 && (s -= 7), e += s * u
                        }
                        return e
                    };e.exports={toAlphaCode:u,fromAlphaCode:f}},{}],2:[function(r, e, n){"use strict";
                const o = r("./unpack");e.exports=function(r){
                const e = r.split("|").reduce(function (r, e) {
                    const n = e.split("¦");
                    return r[n[0]] = n[1], r
                }, {}), n = {};return Object.keys(e).forEach(function(r){
                const t = o(e[r]);"true"===r&&(r=!0);for(const i=0; i<t.length; i++){
                const u = t[i];n.hasOwnProperty(u)===!0?Array.isArray(n[u])===!1?n[u]=[n[u],r]:n[u].push(r):n[u]=r}}),n}},{"./unpack":4}],3:[function(r, e, n){"use strict";
                const o = r("../encoding");e.exports=function(r){
                const e = new RegExp("([0-9A-Z]+):([0-9A-Z]+)"),
                    n = 0;
                for(; n<r.nodes.length; n++){
                let t = e.exec(r.nodes[n]);if(!t){r.symCount=n;break}r.syms[o.fromAlphaCode(t[1])]=o.fromAlphaCode(t[2])}r.nodes=r.nodes.slice(r.symCount,r.nodes.length)}},{"../encoding":1}],4:[function(r, e, n){"use strict";
                const o = r("./symbols"),
                    t = r("../encoding"), i = function (r, e, n) {
                        const o = t.fromAlphaCode(e);
                        return o < r.symCount ? r.syms[o] : n + o + 1 - r.symCount
                    }, u = function (r) {
                        const e = [],
                            n = function n(o, t) {
                                let u = r.nodes[o];
                                "!" === u[0] && (e.push(t), u = u.slice(1));
                                const f = u.split(/([A-Z0-9,]+)/g);
                                let s = 0;
                                for (; s < f.length; s += 2) {
                                    const a = f[s],
                                        c = f[s + 1];
                        ...
                        return r.match(":") && o(e), u(e)
                    };e.exports=f},{"../encoding":1,"./symbols":3}]},{},[2])(2)}),function(r){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=r();else if("function"==typeof define&&define.amd)define([],r);else{
            let e;e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,e.unpack=r()}}(function(){return function r(e, n, o){function t(u, f){if(!n[u]){if(!e[u]){
            const s = "function" == typeof _dereq_ && _dereq_;if(!f&&s)return s(u,!0);if(i)return i(u,!0);
            const a = new Error("Cannot find module '" + u + "'");throw a.code="MODULE_NOT_FOUND",a}
            const c = n[u] = {exports: {}};e[u][0].call(c.exports,function(r){
            ...
            const n = e[u][1][r];return t(n?n:r)},c,c.exports,r,e,n,o)}return n[u].exports}for(var i="function"==typeof _dereq_&&_dereq_,u=0; u<o.length; u++)t(o[u]);return t}({1:[function(r, e, n){"use strict";
                ...
                const o = r("./symbols"),
                    t = r("../encoding"), i = function (r, e, n) {
                        ...
                        return r.match(":") && o(e), u(e)
                    };e.exports=f},{"../encoding":1,"./symbols":3}]},{},[2])(2)});
...
},{"./tags":134}],4:[function(_dereq_,module,exports){
    (function (global){
        'use strict';
...
//the main function
        const nlp = function nlp(str, lex) {
            if (lex) {
                w.plugin({
                    words: lex
                });
            }
            const doc = buildText(str, w);
            doc.tagger();
            return doc;
        };
...
//make a weird, half-copy of this method
        nlp.clone = function () {
            const w2 = world.reBuild();
            //this is weird, but it's okay
            const nlp2 = function nlp2(str, lex) {
                if (lex) {
                    w2.plugin({
                        words: lex
                    });
                }
                const doc = buildText(str, w2);
                doc.tagger();
                return doc;
            };
...
},{"../package.json":2,"./log":6,"./text/build":186,"./world":210,"./world/unpack":218}],5:[function(_dereq_,module,exports){
    'use strict';
...
// };
        ...
        const tag = function tag(t, pos, reason) {
        ...
        const untag = function untag(t, pos, reason) {
            let title = t.normal || '[' + t.silent_term + ']';
            title = fns.leftPad('\'' + title + '\'', 12);
            title += '  ~*   ' + pos;
            title += '    ' + (reason || '');
...
},{"./fns":3,"./terms":162}],9:[function(_dereq_,module,exports){
    'use strict';
        ...
        const methods = {
            data: function data() {
                return this.terms().list.map(function (ts) {
                    const t = ts.terms[0];
                    const parsed = t.text.toUpperCase().replace(/\./g).split('');
                    return {
                        periods: parsed.join('.'),
                        normal: parsed.join(''),
                        text: t.text
...
},{"../../text":188}],10:[function(_dereq_,module,exports){
    'use strict';
...
//is this an adjective we want to goof-around with?
        const shouldConvert = function shouldConvert(str, words) {
            if (!str || str.length <= 3) {
                return false;
            }
...
},{"../../text":188,"./methods":11}],11:[function(_dereq_,module,exports){
    'use strict';
...
//turn 'quick' into 'quickly'
    'use strict';
        ...
        const adj_to_adv = function adj_to_adv(str) {
            ...
            for (let _i = 0; _i < transforms.length; _i++) {
...
},{"../../../world/more-data/irregularAdjectives":213}],13:[function(_dereq_,module,exports){
//turn 'quick' into 'quickly'
    'use strict';
        ...
        const to_comparative = function to_comparative(str) {
            //known-irregulars
            ...
            //dont-patterns
            for (let _i = 0; _i < dont_rules.length; _i++) {
                if (dont_rules[_i].test(str) === true) {
                    return null;
                }
            }
            //do-patterns
            for (let _i2 = 0; _i2 < do_rules.length; _i2++) {
...
},{"../../../world/more-data/irregularAdjectives":213}],14:[function(_dereq_,module,exports){
    'use strict';
//convert 'cute' to 'cuteness'
        ...
        const to_noun = function to_noun(w) {
...
//turn 'quick' into 'quickest'
    'use strict';
        ...
        const to_superlative = function to_superlative(str) {
            //irregulars
            if (irregulars.hasOwnProperty(str)) {
                return irregulars[str];
            }
...
},{"../../../world/more-data/irregularAdjectives":213}],16:[function(_dereq_,module,exports){
    'use strict';
...
//(don't do words like 'green' -> 'greenen')
        ...
        const toVerb = function toVerb(str) {
            if (irregulars.hasOwnProperty(str) === true) {
                return irregulars[str];
            }
            if (/e$/.test(str) === true) {
...
},{"../../text":188,"./toAdjective":18}],18:[function(_dereq_,module,exports){
//turns 'quickly' into 'quick'
    'use strict';
        ...
        const toAdjective = function toAdjective(str) {
            if (irregulars.hasOwnProperty(str)) {
                return irregulars[str];
            }
            for (let i = 0; i < transforms.length; i++) {
...
//the plumbing to turn two words into a contraction
        ...
        const contract = function contract(ts) {
    ...
    'use strict';
        ...
        const ContractionCl = function ContractionCl(arr, world, original) {
...
//Inherit properties
    ...
    ContractionCl.prototype.data = function () {
        const expanded = expand(this.clone());
        const contracted = contract(this.clone());
        return {
            text: this.out('text'),
...
//turn `i'd` into `i would`
        ...
        const expand = function expand(ts) {
...
//find contractable, expanded-contractions
        ...
        const find = function find(r) {
            const remain = r.not('#Contraction');
            const m = remain.match('(#Noun|#QuestionWord) (#Copula|did|do|have|had|could|would|will)');
...
//the Contractions() subset class
        ...
        const find = function find(r, n) {
            ...
            found.list = found.list.map(function (ts) {
                const c = new ContractionCl(ts.terms, ts.world, ts.refText, ts.refTerms);
                c.contracted = true;
                return c;
            });
            //find currently-expanded
            const expanded = findPossible(r);
...
},{"../../text":188,"./contraction":20,"./findPossible":22}],24:[function(_dereq_,module,exports){
    'use strict';

        const Terms = _dereq_('../../paths').Terms;
        const parseDate = _dereq_('./parseDate');

        const _Date = function _Date(arr, world, refText) {
...
},{"../../text":188,"./date":24,"./month":27,"./weekday":31}],26:[function(_dereq_,module,exports){
    'use strict';
    ...
    'use strict';
        ...
        toShortForm: function toShortForm(t) {
            if (t.tags.Month !== undefined) {
                if (longMonths[t.normal] !== undefined) {
                    const shorten = Object.keys(shortMonths);
                    const punct = t.endPunctuation() || '';
        ...
        toLongForm: function toLongForm(t) {
            if (t.tags.Month !== undefined) {
                if (shortMonths[t.normal] !== undefined) {
                    const longer = Object.keys(longMonths);
                    const punct = t.endPunctuation() || '';
...
//validate a day-of-month
        const isDate = function isDate(num) {
            if (num && num < 31 && num > 0) {
                return true;
            }
            return false;
...
//please change this in one thousand years
        const isYear = function isYear(num) {
...
//
        const parseDate = function parseDate(r) {
            const result = {
                month: null,
                date: null,
                weekday: null,
            ...
            if (m.found) {
                const numbers = m.values().numbers();
                if (isDate(numbers[0])) {
                    result.date = numbers[0];
                }
                const year = parseInt(r.match('#Year').out('normal'), 10);
                if (isYear(year)) {
                    result.year = year;
                }
            }
            if (!m.found) {
                ...
                if (m.found) {
                    const _numbers = m.values().numbers();
                    const num = _numbers[0];
                    if (isDate(num)) {
                        result.date = num;
                    }
                }
                ...
                if (m.found) {
                    const _num = parseInt(r.match('#Year').out('normal'), 10);
                    if (isYear(_num)) {
                        result.year = _num;
                    }
                }
            ...
            if (m.found) {
                const _num2 = m.values().numbers()[0];
                if (isDate(_num2)) {
                    result.date = _num2;
                }
            }
...
//
        const isHour = function isHour(num) {
            if (num && num > 0 && num < 25) {
                return true;
            }
            return false;
        };
        const isMinute = function isMinute(num) {
            if (num && num > 0 && num < 60) {
                return true;
            }
            return false;
        ...
        const parseTime = function parseTime(r) {
            const result = {
                logic: null,
                hour: null,
                minute: null,
            ...
            const logic = r.match('(by|before|for|during|at|until|after) #Time').firstTerm();
            if (logic.found) {
                result.logic = logic.out('normal');
            }

            const time = r.match('#Time');
...
//sunday is 0
    ...
    'use strict';
        ...
        toShortForm: function toShortForm(t) {
            if (t.tags.WeekDay) {
                if (longDays[t.normal] !== undefined) {
                    const shorten = Object.keys(shortDays);
        ...
        toLongForm: function toLongForm(t) {
            if (t.tags.WeekDay) {
                if (shortDays[t.normal] !== undefined) {
                    const longer = Object.keys(longDays);
...
//like an n-gram, but only the endings of matches
        const EndGrams = function EndGrams(arr, world, original) {
...
//do all grams of one size, on one termList
        const getGrams = function getGrams(fts, n) {
            const terms = fts.terms;
            if (terms.length < n) {
                return [];
            }
            const arr = [];
            for (let i = 0; i < terms.length - n + 1; i++) {
                const gram = new Gram(terms.slice(i, i + n));
                arr.push(gram);
            }
            return arr;
        };
...
//left-sided grams
        const startGram = function startGram(fts, n) {
            const terms = fts.terms;
            if (terms.length < n) {
                return [];
            }
            const arr = [new Gram(terms.slice(0, n))];
            return arr;
        };

//right-sided grams
        const endGram = function endGram(fts, n) {
            const terms = fts.terms;
            if (terms.length < n) {
                return [];
            }
            const arr = [new Gram(terms.slice(terms.length - n, terms.length))];
            return arr;
        };

//ngrams are consecutive terms of a specific size
        const buildGrams = function buildGrams(r, options) {
            options = options || {};
...
//this is one-or-more terms together, sorted by frequency
        const Gram = function Gram(arr, world, original) {
            Terms.call(this, arr, world, original);
...
//the Ngrams() subset class
        ...
        const find = function find(r, obj) {
            let sizes = [];
...
},{"../../text":188,"./getGrams":33}],36:[function(_dereq_,module,exports){
    'use strict';

        const Ngrams = _dereq_('./index');
        const getGrams = _dereq_('./getGrams');

        const StartGrams = function StartGrams(arr, world, original) {
            Ngrams.call(this, arr, world, original);
        };
...
//certain words can't be plural, like 'peace'
        ...
        const hasPlural = function hasPlural(t) {
            //end quick
            if (!t.tags.Noun) {
                return false;
            }
...
},{"../../text":188,"./noun":46}],39:[function(_dereq_,module,exports){
    'use strict';
...
//first, try to guess based on existing tags
        const couldEvenBePlural = function couldEvenBePlural(t) {
        ...
        const isPlural = function isPlural(t, world) {
            if (t.tags.Plural) {
                return true;
            }
            if (t.tags.Singular) {
            ...
            for (let _i = 0; _i < rules.singular_indicators.length; _i++) {
...
//'a' regexes
        ...
        const makeArticle = function makeArticle(t) {
            const str = t.normal;
...
//similar to plural/singularize rules, but not the same
        ...
        const plural_indicators = [/(^v)ies$/i, /ises$/i, /ives$/i, /(antenn|formul|nebul|vertebr|vit)ae$/i, /(octop|vir|radi|nucle|fung|cact|stimul)i$/i, /(buffal|tomat|tornad)oes$/i, /(analy|ba|diagno|parenthe|progno|synop|the)ses$/i, /(vert|ind|cort)ices$/i, /(matr|append)ices$/i, /(x|ch|ss|sh|s|z|o)es$/i, /men$/i, /news$/i, /.tia$/i, /(^f)ves$/i, /(lr)ves$/i, /(^aeiouy|qu)ies$/i, /(m|l)ice$/i, /(cris|ax|test)es$/i, /(alias|status)es$/i, /ics$/i];

//similar to plural/singularize rules, but not the same
        const singular_indicators = [/(ax|test)is$/i, /(octop|vir|radi|nucle|fung|cact|stimul)us$/i, /(octop|vir)i$/i, /(rl)f$/i, /(alias|status)$/i, /(bu)s$/i, /(al|ad|at|er|et|ed|ad)o$/i, /(ti)um$/i, /(ti)a$/i, /sis$/i, /(?:(^f)fe|(lr)f)$/i, /hive$/i, /(^aeiouy|qu)y$/i, /(x|ch|ss|sh|z)$/i, /(matr|vert|ind|cort)(ix|ex)$/i, /(m|l)ouse$/i, /(m|l)ice$/i, /(antenn|formul|nebul|vertebr|vit)a$/i, /.sis$/i, /^(?!talis|.*hu)(.*)man$/i];
        module.exports = {
...
//turn 'shoe' into 'shoes'
        const pluralize = function pluralize(str, world) {
...
//turn 'shoes' into 'shoe'
        const toSingle = function toSingle(str, world) {
            //reverse it //TODO: cache in world object somewhere
            const irregulars = world.cache.toSingular || {};
            //check irregulars
            if (irregulars.hasOwnProperty(str) === true) {
                return irregulars[str];
            }
            if (world && world.plurals) {
                //given irregulars
                const keys = Object.keys(world.plurals);
                for (let i = 0; i < keys.length; i++) {
            ...
            //regular rule-based inflector
            for (let _i = 0; _i < singleRules.length; _i++) {
...
// console.log(toSingle('days'))
    ...
    'use strict';
        ...
        const Terms = _dereq_('../../paths').Terms;
        const _hasPlural = _dereq_('./hasPlural');
        const _isPlural = _dereq_('./isPlural');
        ...
        const Noun = function Noun(arr, world, refText) {
            Terms.call(this, arr, world, refText);
...
// not intended for classification, or discrimination of people.
        ...
        const gender = function gender(firstName) {
            if (!firstName) {
                return null;
            }
            //statistical guesses
...
},{"../../text":188,"./person":49}],49:[function(_dereq_,module,exports){
    'use strict';

        const Terms = _dereq_('../../paths').Terms;
        const _guessGender = _dereq_('./guessGender');

        const Person = function Person(arr, world, refText, refTerms) {
            ...
            if (!this.firstName.found && this.length > 1) {
                const m = this.not('(#Acronym|#Honorific)');
    ...
    Person.prototype = Object.create(Terms.prototype);
        ...
        const methods = {
            ...
            guessGender: function guessGender() {
                ...
                const str = this.firstName.out('normal');
                return _guessGender(str);
            },
            pronoun: function pronoun() {
                const str = this.firstName.out('normal');
                const g = this.guessGender(str);
                if (g === 'Male') {
                    return 'he';
                }
                if (g === 'Female') {
            ...
            root: function root() {
                const first = this.firstName.out('root');
                const last = this.lastName.out('root');
                if (first && last) {
                    return first + ' ' + last;
                }
...
},{"../../text":188,"./sentence":52}],51:[function(_dereq_,module,exports){
    'use strict';

//is this sentence asking a question?

        const isQuestion = function isQuestion(ts) {
            //if it has a question mark..
            const endPunct = ts.endPunctuation();
            ...
            const clauses = ts.match('*').splitAfter('#Comma');
    ...
    'use strict';
        ...
        const Terms = _dereq_('../../paths').Terms;
        const _toNegative = _dereq_('./toNegative');
        const _toPositive = _dereq_('./toPositive');
        const Verb = _dereq_('../verbs/verb');
        const insert = _dereq_('./smartInsert');

//decide on main subject-verb-object
        const parse = function parse(s) {
            //strip conditions first
            const conditions = s.match('#Condition');
            const tmp = s.not('#Condition');
            //choose the verb first
            const verb = tmp.match('#VerbPhrase+').first(); //this should be much smarter
            const vb = verb.out('normal');
            //get subj noun left-of the verb
            const subject = tmp.match('#Determiner? #Adjective+? #Noun ' + vb).first().not('#VerbPhrase');
            //get obj noun right-of the verb
            const object = tmp.match(vb + ' #Preposition? #Determiner? #Noun').first().not('#VerbPhrase');
        ...
        const fixContraction = function fixContraction(contr) {
            if (contr.found) {
                contr.contractions().expand();
            }
        };

        const killContraction = function killContraction(s) {
...
// (he goes / i go)
        const useInfinitive = function useInfinitive(s) {
        ...
        const methods = {
            ...
            toSingular: function toSingular() {
                const nouns = this.match('#Noun').match('!#Pronoun').firstTerm();
            ...
            toPastTense: function toPastTense() {
                const verb = this.mainVerb();
                if (verb) {
                    //this is really ugly..
                    const start = verb.out('root');
                    verb.toPastTense();
                    //support "i'm going"
                    const contr = this.match('#Contraction ' + start);
                    fixContraction(contr);
                    const end = verb.out('root');
                    // this.replace(start, end)
                    const r = this.parentTerms.replace(start, end);
                    return r;
                }
                return this;
            },
            ...
            toFutureTense: function toFutureTense() {
                const verb = this.mainVerb();
                if (verb) {
                    const start = verb.clone(); //.out('root');
                    verb.toFutureTense();
                    //support "i'm going"
                    const contr = this.match('#Contraction ' + start.out('normal'));
                    fixContraction(contr);
                    const end = verb.out('normal');
                    return this.parentTerms.replace(start, end);
                }
        ...
        const Sentence = function Sentence(arr, world, refText, refTerms) {
            Terms.call(this, arr, world, refText, refTerms);
            parse(this);
        };
//Terms inheritence
...
},{"../../paths":8,"../verbs/verb":92,"./smartInsert":53,"./toNegative":54,"./toPositive":55}],53:[function(_dereq_,module,exports){
    'use strict';

        const hasCapital = /^[A-Z]/;

//sticking words at the start sentence-sensitive
        const prepend = function prepend(ts, str) {
            const firstTerm = ts.terms[0];
            ts.insertAt(0, str);
...
//sticking words on end sentence-sensitive
        const append = function append(ts, str) {
            const endTerm = ts.terms[ts.terms.length - 1];
            //move the sentence punctuation to the end
            const punct = ts.endPunctuation();
            if (punct) {
                endTerm.killPunctuation();
            }
            ts.insertAt(ts.terms.length, str);
            const newTerm = ts.terms[ts.terms.length - 1];
            if (punct) {
                newTerm.text += punct;
            }
...
//that is, 'i walk' -> 'i don\'t walk', not 'I not walk'
        const toNegative = function toNegative(ts) {
            const lg = ts.match('(everyone|everybody|someone|somebody|always)').first();
            if (lg.found && logicalNegate[lg.out('normal')]) {
                const found = lg.out('normal');
...
//nobody/noone are ambiguous logically (somebody? / everybody?)
        ...
        const toPositive = function toPositive(ts) {
            const m = ts.match('(never|nothing)').first();
            if (m.found) {
                const str = m.out('normal');
                if (logical[str]) {
...
},{"../../paths":8,"../../text":188}],57:[function(_dereq_,module,exports){
    'use strict';

        const numOrdinal = _dereq_('./numOrdinal');
        const _textOrdinal = _dereq_('./textOrdinal');
...
//put a comma or two in
        ...
        const niceNumber = function niceNumber(num) {
            if (!num && num !== 0) {
                return null;
            }
            num = String(num);
...
//turn a number like 5 into an ordinal like 5th
        const numOrdinal = function numOrdinal(num) {
            if (!num && num !== 0) {
                return null;
            }
...
},{"./toString":62}],60:[function(_dereq_,module,exports){
    'use strict';
...
// turns an integer/float into a textual number, like 'fifty-five'
        ...
        const sequence = [[1e24, 'septillion'], [1e21, 'sextillion'], [1e18, 'quintillion'], [1e15, 'quadrillion'], [1e12, 'trillion'], [1e9, 'billion'], [1e8, 'hundred million'], [1e6, 'million'], [100000, 'hundred thousand'], [1000, 'thousand'], [100, 'hundred'], [1, 'one']];

//turn number into an array of magnitudes, like [[5, million], [2, hundred]]
        const breakdown_magnitudes = function breakdown_magnitudes(num) {
            let working = num;
            const have = [];
...
//turn numbers from 100-0 into their text
        const breakdown_hundred = function breakdown_hundred(num) {
            const arr = [];
            if (num > 100) {
        ...
        const handle_decimal = function handle_decimal(num) {
        ...
        const to_text = function to_text(num) {
...
},{"./toString":62}],61:[function(_dereq_,module,exports){
    'use strict';

        const textValue = _dereq_('./textCardinal');
        const ordinalWord = _dereq_('../../../world/more-data/numbers').toOrdinal;
//
        const textOrdinal = function textOrdinal(num) {
            const words = textValue(num);
...
},{"../../../world/more-data/numbers":215,"./textCardinal":60}],62:[function(_dereq_,module,exports){
    'use strict';

//turn big numbers, like 2.3e+22, into a tonne of 0's
        const numToString = function numToString(n) {
            if (n < 1000000) {
                return String(n);
            }
...
//the Values() subset class
        ...
        const find = function find(r, n) {
            ...
            if (r.has('#Value #Value')) {
                ...
                //"72 82"
                const double = r.match('#Cardinal #Cardinal');
...
},{"../../text":188,"./parse":64,"./value":72}],64:[function(_dereq_,module,exports){
    'use strict';
...
// 2.5, $5.50, 3,432, etc -
        ...
        const parseString = function parseString(str) {
...
},{"./parseText":67}],65:[function(_dereq_,module,exports){
    'use strict';
...
},{"../../../world/more-data/numbers":215,"../paths":71}],66:[function(_dereq_,module,exports){
    'use strict';

//support global multipliers, like 'half-million' by doing 'million' then multiplying by 0.5

        const findModifiers = function findModifiers(str) {
            const mults = [{
...
// turn a section into something we can add to - like 59000
        const section_sum = function section_sum(obj) {
...
},{"./data":65,"./findModifiers":66,"./parseDecimals":68,"./parseNumeric":69,"./validate":70}],68:[function(_dereq_,module,exports){
    'use strict';

        const words = _dereq_('./data');

//concatenate into a string with leading '0.'
        const parseDecimals = function parseDecimals(arr) {
            let str = '0.';
...
},{"./data":65}],69:[function(_dereq_,module,exports){
    'use strict';
//parse a string like "4,200.1" into Number 4200.1

        const parseNumeric = function parseNumeric(str) {
...
//prevent things like 'fifteen ten', and 'five sixty'
        const isValid = function isValid(w, has) {
...
},{"./data":65}],71:[function(_dereq_,module,exports){
    'use strict';

    module.exports = _dereq_('../../paths');

},{"../../paths":8}],72:[function(_dereq_,module,exports){
    'use strict';
...
// };
        ...
        const parseValue = function parseValue(ts) {
        ...
        const isPercent = function isPercent(val, unit) {
            //pre-tagged
...
//set the text as the same num format
        const setNumber = function setNumber(ts, num) {
            let str = ts.val.out();
            if (ts.has('#Ordinal')) {
                if (ts.has('#TextValue')) {
        ...
        const Value = function Value(arr, world, refText, refTerms) {
            Terms.call(this, arr, world, refText, refTerms);
            parseValue(this);
        };
...
},{"../../paths":8,"./format":57,"./parse":64}],73:[function(_dereq_,module,exports){
    'use strict';
...
},{"../../text":188,"./verb":92}],74:[function(_dereq_,module,exports){
    'use strict';
...
//'walking' - aka progressive
        const isContinuous = function isContinuous(ts) {
            return ts.match('#Gerund').found;
        };

//will not walk
        const isNegative = function isNegative(ts) {
            const negs = ts.match('#Negative').list;
            if (negs.length === 2) {
                return false;
            }
            if (negs.length === 1) {
...
//been walked by..
        const isPassive = function isPassive(ts) {
...
//had walked
        const isPerfect = function isPerfect(ts) {
...
//should walk, could walk
        const getModal = function getModal(ts) {
            const modal = ts.match('#Modal');
            if (!modal.found) {
                return null;
            }
...
//past/present/future
        const getTense = function getTense(ts) {
            ...
            if (ts.verb) {
                ...
                const tense = predict(ts.verb); //yikes
...
// 'will' -> future, 'have'->perfect, modals, negatives, adverbs
        const interpret = function interpret(ts) {
            const isNeg = isNegative(ts);
...
},{"./methods/isPlural":84,"./methods/predict":85}],75:[function(_dereq_,module,exports){
    'use strict';
...
//turn a verb into all it's forms
        const conjugate = function conjugate(t, world) {
            ...
            const inf = all['Infinitive'] || t.normal;
...
},{"../predict":85,"../toInfinitive":88,"./generic":78,"./irregulars":80,"./suffixes":81,"./toActor":82,"./toBe":83}],76:[function(_dereq_,module,exports){
    'use strict';
...
//it's way faster because it knows input is already infinitive
        ...
        const fasterConjugate = function fasterConjugate(inf, world) {
            const all = {
                Infinitive: inf
            };
...
},{"./generic":78,"./irregulars":80,"./suffixes":81}],78:[function(_dereq_,module,exports){
    'use strict';
...
//conjugation using auxillaries+adverbs and stuff
        const multiWordConjugate = function multiWordConjugate(vb, verbose) {
            // if (vb.verb.tags.Contraction) {
            //   console.log(vb.verb.silent_term);
            // }
            const isNegative = vb.negative.found;
            const isPlural = vb.isPlural();
            ...
            const obj = conjugate(vb.verb, vb.world, verbose);
            //apply particles
            ...
            if (vb.adverbs.found) {
                ...
                const isFirst = vb.first().match('#Adverb').found;
                Object.keys(obj).forEach(function (k) {
                    if (isFirst) {
...
},{"./conjugate":75,"./toBe":83}],80:[function(_dereq_,module,exports){
    'use strict';
// let irregulars = require('../../../../lexicon/uncompressed/irregularVerbs').irregulars; //weeee!
        ...
        const checkIrregulars = function checkIrregulars(str, world) {
            ...
            if (irregulars.hasOwnProperty(str) === true) {
                const obj = fns.copy(irregulars[str]);
                obj.Infinitive = str;
                return obj;
            }
            ...
            for (let i = 0; i < infArr.length; i++) {
                for (let o = 0; o < forms.length; o++) {
                    const irObj = irregulars[infArr[i]];
                    if (irObj[forms[o]] === str) {
                        const _obj = fns.copy(irObj);
...
},{"../../../../fns":3}],81:[function(_dereq_,module,exports){
    'use strict';
...
//check suffix rules
        const suffixPass = function suffixPass(inf) {
            const found = {};
            for (let i = 0; i < rules.length; i++) {
                if (rules[i].reg.test(inf) === true) {
                    const obj = rules[i].repl;
                    for (let o = 0; o < keys.length; o++) {
                        if (obj.hasOwnProperty(keys[o]) === true) {
                            const key = mapping[keys[o]];
                            // console.log(rules[i]);
...
},{"./data/rules":76}],82:[function(_dereq_,module,exports){
    'use strict';
//turn 'walk' into 'walker'
        ...
        const toActor = function toActor(inf) {
            //check blacklist
            if (dont[inf]) {
                return null;
            }
...
//too many special cases for is/was/will be
        ...
        const toBe = function toBe(isPlural, isNegative) {
            const obj = {
                PastTense: 'was',
                PresentTense: 'is',
                FutureTense: 'will be',
...
//othertimes you need its noun 'we walk' vs 'i walk'
        ...
        const isPlural = function isPlural(vb) {
    ...
    'use strict';
        ...
        const predictForm = function predictForm(term) {
            ...
            for (let _i = 0; _i < arr.length; _i++) {
                const substr = term.normal.substr(-arr[_i].length);
...
},{"./suffix_rules":86}],86:[function(_dereq_,module,exports){
    'use strict';
//suffix signals for verb tense, generated from test data
        ...
        for (let i = 0; i < l; i++) {
        const l2 = compact[keys[i]].length;
        for (let o = 0; o < l2; o++) {
...
//turn a infinitiveVerb, like "walk" into an adjective like "walkable"
        ...
        const rules = [[/y$/, 'i'], //relay - reliable
            [/([aeiou][n])$/, '$1n']];
...
//turn any verb into its infinitive form
        ...
        const toInfinitive = function toInfinitive(t, world) {
...
},{"../predict":85,"./rules":89}],89:[function(_dereq_,module,exports){
    'use strict';
...
//these are contractions with a implicit verb.
        const expand = function expand(vb) {
...
//this methods operate on parentTerms, so return subset
        const getVerb = function getVerb(ts) {
        ...
        const toNegative = function toNegative(ts) {
            //would not walk
            const modal = ts.match('#Auxiliary').first(); //.notIf('(is|are|was|will|has|had)').first(); //.first();
            if (modal.found) {
                const index = modal.list[0].index();
                const vb = ts.parentTerms.insertAt(index + 1, 'not', 'Verb');
                vb.match('not').tag('Negative', 'tag-not');
                return getVerb(vb);
            }

            //words that pair easily with a 'not' - 'is not'
            const copula = ts.match('(#Copula|will|has|had|do)').first();
            if (copula.found) {
                const _index = copula.list[0].index();
                const _vb = ts.parentTerms.insertAt(_index + 1, 'not', 'Verb');
                _vb.match('not').tag('Negative', 'tag-not');
                return getVerb(_vb);
            }

            const isPlural = ts.isPlural();

            //walked -> did not walk
            const past = ts.match('#PastTense').last();
            if (past.found) {
                // past.debug();
                const first = past.list[0];
                const _index2 = first.index();
                first.terms[0].text = toInfinitive(first.terms[0], ts.world);
                const _vb2 = ts.parentTerms.insertAt(_index2, 'did not', 'Verb');
                //add 'do not'?
            ...
            //walks -> does not walk
            const pres = ts.match('#PresentTense').first();
            if (pres.found) {
                const _first = pres.list[0];
                const _index3 = _first.index();
                _first.terms[0].text = toInfinitive(_first.terms[0], ts.world);
                //some things use 'do not', everything else is 'does not'
                const noun = ts.getNoun();
                let _vb3 = null;
            ...
            //not walking
            const gerund = ts.match('#Gerund').last();
            if (gerund.found) {
                const _index4 = gerund.list[0].index();
                const _vb4 = ts.parentTerms.insertAt(_index4, 'not', 'Verb');
                _vb4.match('not').tag('Negative', 'tag-not');
                return getVerb(_vb4);
            }

            //walk -> do not walk
            const verb = ts.match('#Verb').last();
            if (verb.found) {
                const _first2 = verb.list[0];
                const _index5 = _first2.index();
    ...
    'use strict';
        ...
        const methods = {
            ...
            getNoun: function getNoun() {
                ...
                const str = '#Adjective? #Noun+ ' + this.out('normal');
            ...
            toPastTense: function toPastTense() {
                ...
                const obj = this.conjugate();
                const r = this.replaceWith(obj.PastTense, false);
            ...
            toPresentTense: function toPresentTense() {
                ...
                const obj = this.conjugate();
                const r = this.replaceWith(obj.PresentTense, false);
            ...
            toFutureTense: function toFutureTense() {
                ...
                const obj = this.conjugate();
                const r = this.replaceWith(obj.FutureTense, false);
            ...
            toInfinitive: function toInfinitive() {
                ...
                const obj = this.conjugate();
                const r = this.replaceWith(obj.Infinitive, false);
        ...
        const Verb = function Verb(arr, world, refText, parentTerms) {
...
},{"../../paths":8,"./interpret":74,"./methods/conjugate":79,"./methods/isPlural":84,"./methods/toAdjective":87,"./methods/verbContraction":90,"./toNegative":91}],93:[function(_dereq_,module,exports){
    'use strict';
//the steps and processes of pos-tagging
        ...
        const tagger = function tagger(ts) {
...
},{"./phrase":96,"./steps/01-punctuation_step":97,"./steps/02-emoji_step":98,"./steps/03-lexicon_step":99,"./steps/04-lexicon_multi":100,"./steps/05-web_step":101,"./steps/06-suffix_step":102,"./steps/07-neighbour_step":103,"./steps/08-capital_step":104,"./steps/09-noun_fallback":105,"./steps/10-contractions":106,"./steps/11-date_step":107,"./steps/12-auxiliary_step":108,"./steps/13-negation_step":109,"./steps/14-comma_step":110,"./steps/15-possessive_step":111,"./steps/16-acronym_step":112,"./steps/17-person_step":113,"./steps/18-quotation_step":114,"./steps/19-organization_step":115,"./steps/20-plural_step":116,"./steps/21-value_step":117,"./steps/22-corrections":118,"./steps/23-proper_noun":119,"./steps/24-custom":120}],94:[function(_dereq_,module,exports){
    'use strict';

//

        const conditionPass = function conditionPass(ts) {
...
//a verbPhrase is a sequence of axiliaries, adverbs and verbs
        ...
        const verbPhrase = function verbPhrase(ts) {
...
//
        const phraseTag = function phraseTag(ts) {
            ts = conditionPass(ts);
            ts = verbPhrase(ts);
            // ts = nounPhrase(ts);
...
},{"./00-conditionPass":94,"./01-verbPhrase":95}],97:[function(_dereq_,module,exports){
    'use strict';
//regs-
...
//not so smart (right now)
        const isRomanNumeral = function isRomanNumeral(t) {
        ...
        const punctuation_step = function punctuation_step(ts) {
            const rules = ts.world.regex || [];
...
//https://github.com/Kikobeats/emojis-keywords/blob/master/index.js
        const isCommaEmoji = function isCommaEmoji(t) {
            if (t.text.charAt(0) === ':') {
...
//check against emoticon whitelist
        const isEmoticon = function isEmoticon(t) {
            //normalize the 'eyes'
...
//
        const emojiStep = function emojiStep(ts) {
...
},{"./rules/emoji_regex":127,"./rules/emoticon_list":128}],99:[function(_dereq_,module,exports){
    'use strict';
...
// const lexicon = l.lexicon;
        ...
        const lexicon_pass = function lexicon_pass(ts) {
            ...
            for (let i = 0; i < ts.terms.length; i++) {
                ...
                if (parts && parts.start) {
                    const start = parts.start.toLowerCase();
...
},{"./contraction/split":126}],100:[function(_dereq_,module,exports){
    'use strict';

        const MAX = 4;

//find terms in the lexicon longer than one word (like 'hong kong')
        const findMultiWords = function findMultiWords(ts, i, world) {
            const lex = world.words;
            const start = ts.terms[i].root;
            const nextTerms = ts.terms.slice(i + 1, i + MAX).map(function (t) {
                return t.root;
            });
            ...
            for (let k = max; k > 0; k -= 1) {
                const howAbout = start + ' ' + nextTerms.slice(0, k).join(' ');
...
//try multiple-word matches in the lexicon (users and default)
        const lexiconMulti = function lexiconMulti(ts) {
            ts.world.cache = ts.world.cache || {};
            const firstWords = ts.world.cache.firstWords || {};
            for (let i = 0; i < ts.terms.length; i++) {
                const t = ts.terms[i];
                //try multi words from user-lexicon
                if (firstWords.hasOwnProperty(t.root) === true) {
                    const jump = findMultiWords(ts, i, ts.world);
                    i += jump;
                    continue;
                }
            }
...
//regs
        ...
        const web_pass = function web_pass(terms) {
            for (let i = 0; i < terms.length; i++) {
                const t = terms.get(i);
                const str = t.text.trim().toLowerCase();
...
//straight-up lookup of known-suffixes
        const lookup = function lookup(t) {
            ...
            for (let i = max; i > 1; i -= 1) {
                const str = t.normal.substr(len - i, len);
...
//word-regexes indexed by last-character
        const regexFn = function regexFn(t) {
            const char = t.normal.charAt(t.normal.length - 1);
        ...
        const suffix_step = function suffix_step(ts) {
            for (let i = 0; i < ts.terms.length; i++) {
                const t = ts.terms[i];
                //try known suffixes
                let tag = lookup(t);
...
},{"./rules/regex_list":130,"./rules/suffix_lookup":131}],103:[function(_dereq_,module,exports){
    'use strict';
...
//for unknown terms, look left + right first, and hit-up the markov-chain for clues
        const neighbour_step = function neighbour_step(ts) {
            ts.terms.forEach(function (t, n) {
                //is it still unknown?
                const termTags = Object.keys(t.tags);
                if (termTags.length === 0) {
                    const lastTerm = ts.terms[n - 1];
                    const nextTerm = ts.terms[n + 1];
...
},{"./rules/neighbours":129}],104:[function(_dereq_,module,exports){
    'use strict';
//titlecase is a signal for a noun

        const capital_logic = function capital_logic(s) {
            //(ignore first word)
...
//are the tags basically empty
        const gotNothing = function gotNothing(t) {
            //fail-fast
...
//in last-ditch, try to match 'rewatch' -> 'watch' in the lexicon
        const tryRoot = function tryRoot(t) {
            if (/^(re|un)-?[^aeiou]./.test(t.normal) === true) {
                const str = t.normal.replace(/^(re|un)-?/, '');
                if (t.world.words.hasOwnProperty(str) === true) {
                    const tag = t.world.words[str];
        ...
        const noun_fallback = function noun_fallback(s) {
...
},{"./contraction/01-irregulars":121,"./contraction/02-isWasHas":122,"./contraction/03-easyOnes":123,"./contraction/04-numberRange":124}],107:[function(_dereq_,module,exports){
    'use strict';
...
//please change in one thousand years
        const tagYear = function tagYear(v, reason) {
            if (v.found !== true) {
                return;
            }
            v.list.forEach(function (ts) {
                const num = parseInt(ts.terms[0].normal, 10);
                if (num && num > 1000 && num < 3000) {
...
//same, but for less-confident values
        const tagYearSafer = function tagYearSafer(v, reason) {
            if (v.found !== true) {
                return;
            }
            v.list.forEach(function (ts) {
...
//non-destructively tag values & prepositions as dates
        const datePass = function datePass(ts) {
            ...
            if (ts.has('#Value')) {
                ...
                //may twenty five
                const vs = ts.match('#TextValue #TextValue');
            ...
            if (ts.has('#Date')) {
                ...
                //fix over-greedy
                const date = ts.match('#Date+').splitOn('Clause');
...
// 'not' is sometimes a verb, sometimes an adjective
        ...
        const negation_step = function negation_step(ts) {
...
//like Toronto, Canada
        ...
        const isPlaceComma = function isPlaceComma(ts, i) {
            const t = ts.terms[i];
            const nextTerm = ts.terms[i + 1];
...
//adj, noun, or verb
        const mainTag = function mainTag(t) {
            if (t.tags.Adjective) {
                return 'Adjective';
            }
            if (t.tags.Noun) {
...
//the words with a comma must be the same pos.
        const isList = function isList(ts, i) {
            const start = i;
            const tag = mainTag(ts.terms[i]);
        ...
        const commaStep = function commaStep(ts) {
            ...
            for (let _i = 0; _i < ts.terms.length; _i++) {
                const _t = ts.terms[_i];
                if (_t.tags.Comma) {
...
//a possessive means "'s" describes ownership, not a contraction, like 'is'
        const is_possessive = function is_possessive(terms, x) {
            const t = terms.get(x);
...
//tag each term as possessive, if it should
        const possessiveStep = function possessiveStep(terms) {
            for (let i = 0; i < terms.length; i++) {
...
//we guess if letters are an acronym in the Term class.
        ...
        const acronym_step = function acronym_step(ts) {
            ts.terms.forEach(function (t) {
                if (t.isAcronym()) {
...
//sort-out things like 'theresa may', or 'will jones'.
        ...
        const person_step = function person_step(ts) {
            //mr Putin
            ts.match('(mr|mrs|ms|dr) (#TitleCase|#Possessive)+').tag('#Person', 'mr-putin');

            //a bunch of ambiguous first names
            const maybeNoun = '(rose|robin|dawn|ray|holly|bill|joy|viola|penny|sky|violet|daisy|melody|kelvin|hope|mercedes|olive|jewel|faith|van|charity|miles|lily|summer|dolly|rod|dick|cliff|lane|reed|kitty|art|jean|trinity)';
            if (ts.has(maybeNoun)) {
            ...
            if (ts.has('#FirstName')) {
                ...
                const tmp = ts.match('#FirstName #Noun').ifNo('^#Possessive').ifNo('#ClauseEnd .');
...
//tag a inline quotation as such
        const quotation_step = function quotation_step(ts) {
            for (let i = 0; i < ts.terms.length; i++) {
                const t = ts.terms[i];
...
//orgwords like 'bank' in 'Foo Bank'
        ...
        const orgWords = _dereq_('../../world/more-data/orgWords');

//could this word be an organization
        const maybeOrg = function maybeOrg(t) {
            //must be a noun
            if (!t.tags.Noun) {
                return false;
            }
        ...
        const organization_step = function organization_step(ts) {
            for (let i = 0; i < ts.terms.length; i++) {
                const t = ts.terms[i];
                if (orgWords.hasOwnProperty(t.normal) === true) {
                    //eg. Toronto University
                    const lastTerm = ts.terms[i - 1];
...
},{"../../world/more-data/orgWords":216}],116:[function(_dereq_,module,exports){
    'use strict';

        const isPlural = _dereq_('../../subset/nouns/isPlural');

        const pluralStep = function pluralStep(ts) {
            for (let i = 0; i < ts.terms.length; i++) {
                const t = ts.terms[i];
                if (t.tags.Noun) {
                    //skip existing fast
                    ...
                    const plural = isPlural(t, t.world); //can be null if unknown
                    if (plural === true) {
...
},{"../../subset/nouns/isPlural":39}],117:[function(_dereq_,module,exports){
    'use strict';
//regs-
        ...
        const value_step = function value_step(ts) {
            for (let i = 0; i < ts.terms.length; i++) {
                const t = ts.terms[i];
                if (t.tag.Value === true) {
                    //ordinal/cardinal
...
//mostly pos-corections here
        ...
        const corrections = function corrections(ts) {
            ...
            if (ts.has('#Hyphenated')) {
                ...
                const hyphen = ts.match('#Hyphenated+');
...
//a specificly-named thing, that should be capitalized
        const properNoun = function properNoun(ts) {
...
//patterns are .match() statements to be run after the tagger
        const posthoc = function posthoc(ts) {
...
//check irregulars
        const checkIrregulars = function checkIrregulars(ts) {
            for (let i = 0; i < ts.terms.length; i++) {
                const t = ts.terms[i];
                if (irregulars[t.normal]) {
                    const fix = irregulars[t.normal];
...
// 'spencer's house' vs 'spencer's good'
        const isPossessive = function isPossessive(ts, i) {
            const t = ts.terms[i];
...
// you ain't / i ain't.
        const isAre = function isAre(ts, i) {
            const arr = ['is', 'not']; //default
            //get what's it 'about'
            if (ts.terms[i - 1]) {
...
//handle ambigous contraction "'s"
        const hardOne = function hardOne(ts) {
            for (let i = 0; i < ts.terms.length; i++) {
                //skip existing
                ...
                if (ts.terms[i].normal === 'ain\'t' || ts.terms[i].normal === 'aint') {
                    const arr = isAre(ts, i);
                    ts = fixContraction(ts, arr, i);
                    i += 1;
                    continue;
                }
                const parts = splitContraction(ts.terms[i]);
                if (parts) {
                    ...
                    if (parts.end === 's') {
                        ...
                        let _arr = [parts.start, 'is'];
                        if (ts.terms[i + 1]) {
                            const str = ts.terms[i].normal;
                            //he's walking -> is/was
...
},{"./fix":125,"./split":126}],123:[function(_dereq_,module,exports){
    'use strict';
...
//unambiguous contractions, like "'ll"
        const easyOnes = function easyOnes(ts) {
            for (let i = 0; i < ts.terms.length; i++) {
                //skip existing
                if (ts.terms[i].silent_term) {
                    continue;
                }
                const parts = split(ts.terms[i]);
                if (parts) {
                    parts.start = parts.start.toLowerCase();

                    //make sure its an easy one
                    if (easy_ends[parts.end]) {
                        const arr = [parts.start, easy_ends[parts.end]];
                        ts = fixContraction(ts, arr, i);
                        i += 1;
                    }
...
},{"./fix":125,"./split":126}],124:[function(_dereq_,module,exports){
    'use strict';

        const fixContraction = _dereq_('./fix');
        const Term = _dereq_('../../../term');

        const hasDash = function hasDash(t) {
            const dashes = /(-|–|—)/;
            return dashes.test(t.whitespace.before) || dashes.test(t.whitespace.after);
        };

        const numberRange = function numberRange(ts) {
...
},{"../../../term":140,"./fix":125}],125:[function(_dereq_,module,exports){
    'use strict';
...
//make sure the newly created term gets the easy tags
        const easyTag = function easyTag(t) {
...
//add a silent term
        const fixContraction = function fixContraction(ts, parts, i) {
            //add the interpretation to the contracted term
            const one = ts.terms[i];
...
},{"../../../term":140}],126:[function(_dereq_,module,exports){
    'use strict';
        ...
        const splitContraction = function splitContraction(t) {
            ...
            const parts = t.normal.match(contraction);
...
//add 'downward' tags (that immediately depend on this one)
        ...
        const addDownword = function addDownword(tags) {
...
//extend tagset with new tags
        const addIn = function addIn(obj, tags) {
            Object.keys(obj).forEach(function (k) {
                tags[k] = obj[k];
            });
        };
...
//add tags to remove when tagging this one
        const addConflicts = function addConflicts(tags) {
        ...
        const addColors = function addColors(tags) {
            Object.keys(tags).forEach(function (k) {
                if (colors[k]) {
...
},{"./addDownward":132,"./conflicts":133,"./tags/dates":135,"./tags/misc":136,"./tags/nouns":137,"./tags/values":138,"./tags/verbs":139}],135:[function(_dereq_,module,exports){
    'use strict';
...
//normalization
        ...
        const Term = function Term(str, world) {
            this.tags = {};
            ...
            const parsed = build_whitespace(this._text);
    ...
    Term.prototype.clone = function () {
        const term = new Term(this._text, this.world);
...
},{"./makeUID":141,"./methods/case":143,"./methods/misc":144,"./methods/normalize/normalize":146,"./methods/normalize/root":147,"./methods/out":150,"./methods/punctuation":153,"./methods/tag":155,"./paths":158,"./whitespace":159}],141:[function(_dereq_,module,exports){
    'use strict';
...
// const tagSet = require('../paths').tags;
        ...
        const bestTag = function bestTag(t) {
    ...
    'use strict';
        ...
        const addMethods = function addMethods(Term) {
            const methods = {
                ...
                needsTitleCase: function needsTitleCase() {
                    const titleCases = ['Person', 'Place', 'Organization', 'Acronym', 'UpperCase', 'Currency', 'RomanNumeral', 'Month', 'WeekDay', 'Holiday', 'Demonym'];
                    ...
                    for (let _i = 0; _i < irregulars.length; _i++) {
    ...
    'use strict';
        ...
        const _isAcronym = _dereq_('./normalize/isAcronym');
        const _bestTag = _dereq_('./bestTag');
...
},{"./bestTag":142,"./normalize/isAcronym":145}],145:[function(_dereq_,module,exports){
    'use strict';
//regs -
        ...
        const isAcronym = function isAcronym(str) {
            //like N.D.A
...
},{"./isAcronym":145,"./unicode":148}],147:[function(_dereq_,module,exports){
    'use strict';
//

        const rootForm = function rootForm(term) {
...
//decompress data into two hashes
        ...
        const killUnicode = function killUnicode(str) {
...
//a nicer logger for the client-side
        const clientSide = function clientSide(t) {
            let color = 'silver';
            const tags = Object.keys(t.tags);
            for (let i = 0; i < tags.length; i++) {
...
},{"./client":149,"./renderHtml":151,"./server":152}],151:[function(_dereq_,module,exports){
    'use strict';
//turn xml special characters into apersand-encoding.
//i'm not sure this is perfectly safe.

        const escapeHtml = function escapeHtml(s) {
            const HTML_CHAR_MAP = {
                '<': '&lt;',
                '>': '&gt;',
                '&': '&amp;',
...
//http://stackoverflow.com/questions/295566/sanitize-rewrite-html-on-the-client-side
        const sanitize = function sanitize(html) {
            const tagBody = '(?:[^"\'>]|"[^"]*"|\'[^\']*\')*';
...
//turn the term into ~properly~ formatted html
        const renderHtml = function renderHtml(t) {
            let classes = Object.keys(t.tags).filter(function (tag) {
                return tag !== 'Term';
            });
            ...
            const el = '<span class="' + classes + '">' + text + '</span>';
...
//pretty-print a term on the nodejs console
        const serverDebug = function serverDebug(t) {
            const tags = Object.keys(t.tags).map(function (tag) {
...
},{"../../paths":158}],153:[function(_dereq_,module,exports){
    'use strict';
        ...
        const addMethods = function addMethods(Term) {
            const methods = {
                ...
                endPunctuation: function endPunctuation() {
                    const m = this.text.match(endPunct);
                    if (m) {
                        return m[2];
                    }
                    return null;
...
//recursively-check compatibility of this tag and term
        ...
        const canBe = function canBe(term, tag) {
    ...
    'use strict';
        ...
        const _unTag = _dereq_('./unTag');
        const _canBe = _dereq_('./canBe');
...
},{"./canBe":154,"./setTag":156,"./unTag":157}],156:[function(_dereq_,module,exports){
    'use strict';
...
// const tagset = require('../../../tagset');
        ...
        const putTag = function putTag(term, tag, reason) {
            const tagset = term.world.tags;
            tag = tag.replace(/^#/, '');
            //already got this
...
//give term this tag
        const wrap = function wrap(term, tag, reason) {
            if (!term || !tag) {
                return;
            }
            const tagset = term.world.tags;
...
},{"../../paths":158,"./unTag":157}],157:[function(_dereq_,module,exports){
    'use strict';
//set a term as a particular Part-of-speech
...
//remove a tag from a term
        const unTag = function unTag(term, tag, reason) {
            const tagset = term.world.tags;
            if (term.tags[tag]) {
                ...
                if (tagset[tag]) {
                    const also = tagset[tag].downward;
...
},{"../../paths":158}],158:[function(_dereq_,module,exports){
    'use strict';
...
},{"../fns":3,"../log":6}],159:[function(_dereq_,module,exports){
    'use strict';
//punctuation regs-
...
//works in concert with ./src/text/tokenize.js
        const build_whitespace = function build_whitespace(str) {
            const whitespace = {
                before: '',
                after: ''
            };
    ...
    'use strict';
        ...
        const hasHyphen = function hasHyphen(str) {
            //dont split 're-do'
            if (/^(re|un)-?[^aeiou]./.test(str) === true) {
                return false;
            }
...
//turn a string into an array of terms (naiive for now, lumped later)
        const fromString = function fromString(str, world) {
            const result = [];
            const arr = [];
...
},{"../term":140}],161:[function(_dereq_,module,exports){
    'use strict';
...
//getters/setters for the Terms class
    ...
    'use strict';
        ...
        const w = _dereq_('../world');

//Terms is an array of Term objects, and methods that wrap around them
        const Terms = function Terms(arr, world, refText, refTerms) {
            const _this = this;
        ...
        const termArr = build(str, world);
        const ts = new Terms(termArr, world, null);
...
},{"../world":210,"./build":160,"./getters":161,"./match":163,"./match/not":172,"./methods/delete":173,"./methods/insert":174,"./methods/loops":175,"./methods/lump":177,"./methods/misc":178,"./methods/out":179,"./methods/replace":180,"./methods/split":181,"./methods/tag":182,"./methods/transform":183}],163:[function(_dereq_,module,exports){
    'use strict';

        const syntax = _dereq_('./lib/syntax');
        const startHere = _dereq_('./lib/startHere');
        const Text = _dereq_('../../text');
        const _match = _dereq_('./lib');

        const matchMethods = function matchMethods(Terms) {
            const methods = {
                ...
                match: function match(reg, verbose) {
                    ...
                    let matches = _match(this, reg, verbose);
                ...
                matchOne: function matchOne(str) {
                    ...
                    const regs = syntax(str);
                    for (let t = 0; t < this.terms.length; t++) {
                        //don't loop through if '^'
                        if (regs[0] && regs[0].starting && t > 0) {
                            break;
                        }
                        const m = startHere(this, t, regs);
                        if (m) {
                            return m;
                        }
                    }
...
},{"../../text":188,"./lib":166,"./lib/startHere":170,"./lib/syntax":171}],164:[function(_dereq_,module,exports){
    'use strict';
//take all the matches, and if there is a [capture group], only return that.

        const onlyCaptureGroup = function onlyCaptureGroup(matches) {
            const results = [];
...
//find easy reasons to skip running the full match on this
        ...
        const fastPass = function fastPass(ts, regs) {
            for (let i = 0; i < regs.length; i++) {
                ...
                if (reg.tag !== undefined) {
                    for (let _o = 0; _o < ts.terms.length; _o++) {
...
//make a reg syntax from a text object
        const findFromTerms = function findFromTerms(ts) {
            const arr = ts.terms.map(function (t) {
                return {
                    id: t.uid
                };
            });
...
//
        const match = function match(ts, reg, verbose) {
...
},{"./captureGroup":164,"./fastPass":165,"./startHere":170,"./syntax":171}],167:[function(_dereq_,module,exports){
    'use strict';

//compare 1 term to one reg

        const perfectMatch = function perfectMatch(term, reg) {
            if (!term || !reg) {
                return false;
            }
            //support '.' - any
...
//wrap above method, to support '!' negation
        const isMatch = function isMatch(term, reg, verbose) {
            if (!term || !reg) {
                return false;
            }
    ...
    'use strict';
        ...
        const almostMatch = function almostMatch(reg_str, term) {
            const want = term.normal.substr(0, reg_str.length);
            return want === reg_str;
        };

// match ['john', 'smith'] regs, when the term is lumped
        const lumpMatch = function lumpMatch(term, regs, reg_i) {
...
},{"../../paths":185,"dup":71}],170:[function(_dereq_,module,exports){
    'use strict';
...
// match everything until this point - '*'
        const greedyUntil = function greedyUntil(ts, i, reg) {
            for (; i < ts.length; i++) {
...
//keep matching this reg as long as possible
        const greedyOf = function greedyOf(ts, i, reg, until) {
            for (; i < ts.length; i++) {
                const t = ts.terms[i];
        ...
        const startHere = function startHere(ts, startAt, regs, verbose) {
            ...
            for (let reg_i = 0; reg_i < regs.length; reg_i++) {
                ...
                if (regs[reg_i].minMax !== undefined) {
                    const min = regs[reg_i].minMax.min || 0;
                    const max = regs[reg_i].minMax.max;
                    ...
                    for (let i = 0; i < max; i++) {
                        ...
                        const nextT = ts.terms[term_i + i + 1];
                ...
                const lumpUntil = lumpMatch(term, regs, reg_i, verbose);
                if (lumpUntil !== null) {
                    reg_i = lumpUntil;
                    term_i += 1;
                    continue;
...
},{"./isMatch":167,"./lumpMatch":168}],171:[function(_dereq_,module,exports){
    'use strict';
...
//trim char#0
        const noFirst = function noFirst(str) {
            return str.substr(1, str.length);
        };
        const noLast = function noLast(str) {
            return str.substring(0, str.length - 1);
        };

//turn 'regex-like' search string into parsed json
        const parse_term = function parse_term(term) {
            term = term || '';
            term = term.trim();
...
//turn a match string into an array of objects
        const parse_all = function parse_all(input) {
            input = input || '';
...
//
        ...
        const addfns = function addfns(Terms) {
            const fns = {
            ...
            fns.notArray = function (r, arr) {
                const obj = arr.reduce(function (h, a) {
                    h[a] = true;
                    return h;
                }, {});
            ...
            Terms.prototype.not = function (want, verbose) {
                ...
                if ((typeof want === 'undefined' ? 'undefined' : _typeof(want)) === 'object') {
                    const type = Object.prototype.toString.call(want);
...
},{"../../text":188,"./lib/startHere":170,"./lib/syntax":171}],173:[function(_dereq_,module,exports){
    'use strict';

        const mutate = _dereq_('../mutate');

        const addMethod = function addMethod(Terms) {
            ...
            Terms.prototype.delete = function (reg) {
                ...
                const found = this.match(reg);
                if (found.found) {
                    const r = mutate.deleteThese(this, found);
                    return r;
                }
...
},{"../mutate":184}],174:[function(_dereq_,module,exports){
    'use strict';

        const mutate = _dereq_('../mutate');

//whitespace
        const addSpaceAt = function addSpaceAt(ts, i) {
        ...
        const insertMethods = function insertMethods(Terms) {

            //accept any sorta thing
            const ensureTerms = function ensureTerms(input, world) {
                if (input.isA === 'Terms') {
                    return input;
                }
                if (input.isA === 'Term') {
                ...
                //handle a string
                const ts = Terms.fromString(input, world);
                ts.tagger();
                return ts;
            };
            ...
            const methods = {
                ...
                insertBefore: function insertBefore(input, tag) {
                    const original_l = this.terms.length;
                    const ts = ensureTerms(input, this.world);
                    if (tag) {
                        ts.tag(tag);
                    }
                ...
                insertAfter: function insertAfter(input, tag) {
                    ...
                    const index = this.terms[this.terms.length - 1].index();
...
},{"../mutate":184}],175:[function(_dereq_,module,exports){
    'use strict';
//these methods are simply term-methods called in a loop

        const addMethods = function addMethods(Terms) {
...
},{"../../../term":140}],177:[function(_dereq_,module,exports){
    'use strict';
...
//merge-together our current match into one term
        const combineThem = function combineThem(ts, tags) {
            const len = ts.terms.length;
            for (let i = 0; i < len; i++) {
                combine(ts, 0);
            }
            const lumped = ts.terms[0];
            lumped.tags = tags;
            return lumped;
        };

        const lumpMethods = function lumpMethods(Terms) {
            ...
            Terms.prototype.lump = function () {
                ...
                if (this.parentTerms === this) {
                    const _lumped = combineThem(this, tags);
                    this.terms = [_lumped];
                    return this;
                }
                ...
                this.parentTerms = mutate.deleteThese(this.parentTerms, this);
                //merge-together our current match into one term
                const lumped = combineThem(this, tags);
...
},{"../../mutate":184,"./combine":176}],178:[function(_dereq_,module,exports){
    'use strict';

        const _tagger = _dereq_('../../tagger');

        const miscMethods = function miscMethods(Terms) {
            const methods = {
                ...
                last: function last() {
                    const t = this.terms[this.terms.length - 1];
                    return new Terms([t], this.world, this.refText, this.refTerms);
                },
                slice: function slice(start, end) {
                    const terms = this.terms.slice(start, end);
...
},{"../../tagger":93}],179:[function(_dereq_,module,exports){
    'use strict';
        ...
        const methods = {
            ...
            normal: function normal(ts) {
                let terms = ts.terms.filter(function (t) {
                    return t.text;
                });
    ...
    methods.tags = methods.terms;
        ...
        const renderMethods = function renderMethods(Terms) {
...
},{"../paths":185}],180:[function(_dereq_,module,exports){
    'use strict';

        const mutate = _dereq_('../mutate');

        const replaceMethods = function replaceMethods(Terms) {
            const methods = {
                /**swap this for that */
                ...
                replaceWith: function replaceWith(str, keepTags) {
                    const newTs = Terms.fromString(str, this.world);
                    newTs.tagger();
                    ...
                    const endPunct = this.endPunctuation();
...
},{"../mutate":184}],181:[function(_dereq_,module,exports){
    'use strict';

//break apart a termlist into (before, match after)

        const breakUpHere = function breakUpHere(terms, ts) {
            const firstTerm = ts.terms[0];
            const len = ts.terms.length;
            for (let i = 0; i < terms.length; i++) {
            ...
            const methods = {
                ...
                splitAfter: function splitAfter(reg, verbose) {
                    ...
                    all = all.map(function (ts) {
                        const parent = _this.refText; //|| this;
    ...
    'use strict';
        ...
        const addMethod = function addMethod(Terms) {
            const methods = {
                ...
                canBe: function canBe(tag) {
                    const terms = this.terms.filter(function (t) {
                        return t.canBe(tag);
                    });
                    return new Terms(terms, this.world, this.refText, this.refTerms);
                }
    ...
    'use strict';
        ...
        const transforms = function transforms(Terms) {
            const methods = {
                clone: function clone() {
                    // this.world = this.world.clone();
                    const terms = this.terms.map(function (t) {
                        return t.clone();
                    });
...
//
        ...
        const getTerms = function getTerms(needle) {
            let arr = [];
            if (needle.isA === 'Terms') {
                arr = needle.terms;
...
},{"../fns":3,"../term":140}],186:[function(_dereq_,module,exports){
    'use strict';
        ...
        const fromString = function fromString(str, world) {
            ...
            const list = sentences.map(function (s) {
                return Terms.fromString(s, world);
            });

            const doc = new Text(list, world);
...
},{"./index":188,"./paths":200,"./tokenize":202}],187:[function(_dereq_,module,exports){
    'use strict';
...
//make a sub-class of this class easily
    Text.makeSubset = function (methods, find) {
        const Subset = function Subset(arr, world, original) {
...
},{"../subset/acronyms":9,"../subset/adjectives":10,"../subset/adverbs":17,"../subset/contractions":23,"../subset/dates":25,"../subset/ngrams":35,"../subset/ngrams/endGrams":32,"../subset/ngrams/startGrams":36,"../subset/nouns":38,"../subset/people":48,"../subset/sentences":50,"../subset/terms":56,"../subset/values":63,"../subset/verbs":73,"./getters":187,"./methods/loops":189,"./methods/match":190,"./methods/misc":191,"./methods/normalize":192,"./methods/out":193,"./methods/sort":197,"./methods/split":199,"./subsets":201}],189:[function(_dereq_,module,exports){
    'use strict';
//this methods are simply loops around each termList object.

        const methods = ['toTitleCase', 'toUpperCase', 'toLowerCase', 'toCamelCase', 'hyphenate', 'dehyphenate', 'trim', 'insertBefore', 'insertAfter', 'insertAt', 'replace', 'replaceWith', 'delete', 'lump', 'tagger',

// 'tag',
            'unTag'];

        const addMethods = function addMethods(Text) {
    ...
    'use strict';
        ...
        const splitMethods = function splitMethods(Text) {
            //support "#Noun word" regex-matches
            const matchReg = function matchReg(r, reg, verbose) {
                //parse the 'regex' into some json
                const list = [];
                reg = syntaxParse(reg);
                r.list.forEach(function (ts) {
                    //an array of arrays
                    const matches = ts.match(reg, verbose);
            ...
            const matchObj = function matchObj(r, obj) {
                let matches = [];
                r.list.forEach(function (ts) {
                    ts.terms.forEach(function (t) {
            ...
            const matchArr = function matchArr(r, arr) {
                //its faster this way
                const obj = arr.reduce(function (h, a) {
                    h[a] = true;
                    return h;
            ...
            const methods = {
                ...
                match: function match(reg, verbose) {
                    ...
                    const type = Object.prototype.toString.call(reg);
                    if (type === '[object Array]') {
                ...
                not: function not(reg, verbose) {
                    let list = [];
                    this.list.forEach(function (ts) {
                        const found = ts.not(reg, verbose);
                ...
                before: function before(reg) {
                    const list = [];
                    for (let i = 0; i < this.list.length; i++) {
                        const m = this.list[i].matchOne(reg);
                        if (m) {
                            const index = m[0].index();
                            const found = this.list[i].slice(0, index);
                            if (found.length > 0) {
                                list.push(found);
                            }
                        }
                ...
                after: function after(reg) {
                    ...
                    for (let i = 0; i < this.list.length; i++) {
                        const m = this.list[i].matchOne(reg);
                        if (m) {
                            const lastTerm = m[m.length - 1];
                            const index = lastTerm.index();
                            const found = this.list[i].slice(index + 1, this.list[i].length);
                            if (found.length > 0) {
                                list.push(found);
                            }
                        }
...
},{"../../../terms":162,"../../../terms/match/lib/syntax":171}],191:[function(_dereq_,module,exports){
    'use strict';
        ...
        const miscMethods = function miscMethods(Text) {
            const methods = {
                all: function all() {
                    return this.parent;
                },
                ...
                map: function map(fn) {
                    ...
                    return this.list.map(function (ts, i) {
                        const text = new Text([ts], _this.world);
                        return fn(text, i);
                    });
                },
                forEach: function forEach(fn) {
                    ...
                    this.list.forEach(function (ts, i) {
                        const text = new Text([ts], _this2.world);
                        fn(text, i);
                    });
                    return this;
                },
                filter: function filter(fn) {
                    ...
                    const list = this.list.filter(function (ts, i) {
                        const text = new Text([ts], _this3.world);
                        return fn(text, i);
                    });
                ...
                reduce: function reduce(fn, h) {
                    ...
                    return this.list.reduce(function (_h, ts) {
                        const text = new Text([ts], _this4.world);
                        return fn(_h, text);
                    }, h);
                },
                find: function find(fn) {
                    for (let i = 0; i < this.list.length; i++) {
                        const ts = this.list[i];
                        const text = new Text([ts], this.world);
                        if (fn(text)) {
                            return text;
                        }
                    }
                ...
                clone: function clone() {
                    const list = this.list.map(function (ts) {
                        return ts.clone();
                    });
...
},{"../../terms":162}],192:[function(_dereq_,module,exports){
    'use strict';
//
        ...
        const methods = {
            ...
            punctuation: function punctuation(r) {
                r.list.forEach(function (ts) {
                    ...
                    //replace !!! with !
                    const last = ts.terms[ts.terms.length - 1];
        ...
        const methods = {
            ...
            json: function json(r) {
                return r.list.reduce(function (arr, ts) {
                    const terms = ts.terms.map(function (t) {
                        return {
                            text: t.text,
                            normal: t.normal,
                            tags: t.tag
            ...
            html: function html(r) {
                const html = r.list.reduce(function (str, ts) {
                    const sentence = ts.terms.reduce(function (sen, t) {
                        sen += '\n    ' + t.out('html');
                        return sen;
                    }, '');
                    return str += '\n  <span>' + sentence + '\n  </span>';
...
},{"./indexes":194,"./offset":195,"./topk":196}],194:[function(_dereq_,module,exports){
    'use strict';
//find where in the original text this match is found, by term-counts

        const termIndex = function termIndex(r) {
            const result = [];
    ...
    'use strict';
        ...
        const findOffset = function findOffset(parent, term) {
            let sum = 0;
            for (let i = 0; i < parent.list.length; i++) {
                for (let o = 0; o < parent.list[i].terms.length; o++) {
                    const t = parent.list[i].terms[o];
                    if (t.uid === term.uid) {
                        return sum;
                    } else {
...
//used for highlighting the actual words, without whitespace+punctuation
        const trimEnds = function trimEnds(ts) {
            const terms = ts.terms;
            if (terms.length <= 2) {
                return ts.out('normal');
            }
            //the start
...
//map over all-dem-results
        const allOffset = function allOffset(r) {
            const parent = r.all();
            return r.list.map(function (ts) {
                const words = [];
                for (let i = 0; i < ts.terms.length; i++) {
                ...
                const nrml = trimEnds(ts);
                const txt = ts.out('text');
                const startAt = findOffset(parent, ts.terms[0]);
                const beforeWord = ts.terms[0].whitespace.before;
                const wordStart = startAt + beforeWord.length;
                return {
                    text: txt,
                    normal: ts.out('normal'),
                    //where we begin
...
//
        ...
        const topk = function topk(r, n) {
            //count occurance
            const count = {};
            r.list.forEach(function (ts) {
                const str = ts.out('root');
...
},{"./methods":198}],198:[function(_dereq_,module,exports){
    'use strict';

//perform sort on pre-computed values

        const sortEm = function sortEm(arr) {
...
//the order they were recieved (chronological~)
    exports.chron = function (r) {
        //pre-compute indexes
        const tmp = r.list.map(function (ts) {
            return {
                ts: ts,
                index: ts.termIndex()
            };
...
},{"../paths":8}],201:[function(_dereq_,module,exports){
    'use strict';

        const isQuestion = _dereq_('../subset/sentences/isQuestion');
        const addSubsets = function addSubsets(Text) {
            ...
            const subsets = {
                ...
                topics: function topics(n) {
                    ...
                    const ignore = ['someone', 'man', 'woman', 'mother', 'brother', 'sister', 'father'];
                    yup = yup.not(ignore);
                ...
                questions: function questions(n) {
                    ...
                    const list = r.list.filter(function (ts) {
...
},{"../subset/sentences/isQuestion":51}],202:[function(_dereq_,module,exports){
...
// Start with a regex:
        const naiive_split = function naiive_split(text) {
            const all = [];
            //first, split by newline
            const lines = text.split(new_line);
            for (let i = 0; i < lines.length; i++) {
                //split by period, question-mark, and exclamation-mark
                const arr = lines[i].split(naiive_sentence_split);
                for (let o = 0; o < arr.length; o++) {
                    all.push(arr[o]);
                }
            }
        ...
        const sentence_parser = function sentence_parser(text) {
            text = text || '';
            text = String(text);
            const sentences = [];
...
//also, map the irregulars for easy infinitive lookup - {bought: 'buy'}
        const addConjugations = function addConjugations(obj) {
            const _this = this;
            ...
            Object.keys(obj).forEach(function (inf) {
                ...
                const forms = conjugate(inf, _this);
...
},{"../subset/verbs/methods/conjugate/faster.js":77}],205:[function(_dereq_,module,exports){
    "use strict";

//
        const addPatterns = function addPatterns(obj) {
            const _this = this;
...
//and both forms in the lexicon
        ...
        const addPlurals = function addPlurals(obj) {
            const _this = this;
...
//
        const addRegex = function addRegex(obj) {
            const _this = this;
...
//extend our known tagset with these new ones
        const addTags = function addTags(tags) {
            const _this = this;
...
},{"../tags/addDownward":132}],209:[function(_dereq_,module,exports){
    'use strict';
...
//
        const addWords = function addWords(words) {
            const _this = this;
            ...
            Object.keys(words).forEach(function (word) {
                ...
                if (tag === 'Infinitive') {
                    const conj = conjugate(word, _this);
                ...
                if (tag === 'PhrasalVerb') {
                    ...
                    const _conj = conjugate(_arr[0], _this);
                    Object.keys(_conj).forEach(function (k) {
                        const form = _conj[k] + ' ' + _arr[1];
                ...
                if (tag === 'Comparable') {
                    const comp = adjFns.toComparative(word);
                    if (comp && word !== comp) {
                        _this.words[comp] = 'Comparative';
                    }
                    const supr = adjFns.toSuperlative(word);
                    if (supr && word !== supr) {
...
},{"../subset/adjectives/methods":11,"../subset/nouns/methods/pluralize":44,"../subset/verbs/methods/conjugate/faster.js":77,"../term/methods/normalize/normalize":146}],210:[function(_dereq_,module,exports){
    'use strict';
// const addWords = require('./addWords');

        const fns = _dereq_('../fns');
        const data = _dereq_('./_data');
        const moreData = _dereq_('./more-data');
        const tags = _dereq_('../tags');
        ...
        const addPatterns = _dereq_('./addPatterns');
        const addPlurals = _dereq_('./addPlurals');
        const misc = _dereq_('./more-data/misc');

//lazier/faster object-merge
        const extend = function extend(main, obj) {
...
},{"../fns":3,"../tags":134,"./_data":203,"./addConjugations":204,"./addPatterns":205,"./addPlurals":206,"./addRegex":207,"./addTags":208,"./addWords":209,"./more-data":212,"./more-data/misc":214,"./unpack":218}],211:[function(_dereq_,module,exports){
...
},{"./abbreviations":211,"./irregularAdjectives":213,"./numbers":215,"./orgWords":216}],213:[function(_dereq_,module,exports){
    'use strict';
//adjectives that have irregular conjugations to adverb, comparative, and superlative forms
        ...
        const combine = function combine(lexicon, obj, tag) {
            const keys = Object.keys(obj);
            for (let i = 0; i < keys.length; i++) {
...
//create an easy mapping between ordinal-cardinal
        ...
        const ord = Object.keys(ordinal[k]);
        const card = Object.keys(cardinal[k]);
...
//
        const unpackVerbs = function unpackVerbs(str) {
            const verbs = str.split('|');
    ...
    */
        ...
        const unpackPlugin = function unpackPlugin(str) {
            let obj = str;
...
},{"./conjugations":217,"./key-value":219,"./plurals":220,"efrt-unpack":1}],219:[function(_dereq_,module,exports){
    'use strict';
//pivot k:[val,val] ->  val:k, val:k

        const keyValue = function keyValue(obj) {
            const keys = Object.keys(obj);
    ...
    'use strict';
        ...
        const unpackPlurals = function unpackPlurals(str) {
