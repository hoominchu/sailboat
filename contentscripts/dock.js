...
$(document).ready(function () {
    chrome.storage.local.get("Settings", function (settings) {
        ...
        chrome.storage.local.get("TASKS", function (taskObject) {
            if (taskObject["TASKS"]) {
                let TASKS = taskObject["TASKS"];//On retreiving TASKS from chrome storage, one gets an object {TASKS: balhah}, to retreive the actual array call taskObject["TASKS"]
...
function loadTaskNames(ctaskid, TASKS) {
